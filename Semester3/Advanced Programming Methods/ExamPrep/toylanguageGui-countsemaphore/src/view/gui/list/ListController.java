    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new StackClass<>(), new DictionaryClass<>(), new ListClass<>(), selectedStatement, new DictionaryClass<>(), new HeapClass(), new SemaphoreTableClass());
                                                        ...
                                                        new ForkStmt(
                                                                new CompStmt(
                                                                        ...
                                                                        new CompStmt(
                                                                                new HeapWriteStmt("v1", new ArithExp(new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(10)),"*")),
                                                                                new CompStmt(
                                                                                        new HeapWriteStmt("v1", new ArithExp( new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(2)),"*")),
                                                                                        new CompStmt(
                                                                                                new PrintStmt(new ReadHeapExp(new VarExp("v1"))),
                                                                                                new ReleaseStmt("cnt")
                                                                                        )
