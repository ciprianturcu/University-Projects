...
public class ProgramController {
    ...
    private void populateSymbolTableView() {
        PrgState programState = getCurrentProgramState();
        InterfaceDictionary<String, Value> symbolTable = Objects.requireNonNull(programState).getSymbolTable();
    ...
    public void populateSemaphoreTableView()
    {
        PrgState programState = getCurrentProgramState();
        InterfaceSemaphoreTable semaphoreTable = Objects.requireNonNull(programState).getSemaphoreTable();
