    ...
    private ObservableList<IStmt> getStatements()
    {
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new IntType()),
                        new CompStmt(new VarDeclStmt("v2", new IntType()),
                                new CompStmt(new AssignStmt("v1", new ValueExp(new IntValue(2))),new CompStmt( new AssignStmt("v2", new ValueExp(new IntValue(3))), new IfStmt(new RelationalExp(new VarExp("v1"), new ValueExp(new IntValue(0)),"!="),new PrintStmt(new MULExpression(new VarExp("v1"),new VarExp("v2"))), new PrintStmt(new VarExp("v1")))))));
