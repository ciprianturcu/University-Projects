    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new StackClass<>(), new DictionaryClass<>(), new ListClass<>(), selectedStatement, new DictionaryClass<>(), new HeapClass());
                                        ...
                                        new CompStmt(new AssignStmt("a", new ValueExp(new IntValue(1))),
                                                new CompStmt(new AssignStmt("b", new ValueExp(new IntValue(2))),
                                                        new CompStmt(new AssignStmt("c", new ValueExp(new IntValue(5))),
                                                                new CompStmt(new SwitchStmt(new ArithExp(new VarExp("a"), new ValueExp(new IntValue(10)),"*"), new ArithExp(new VarExp("b"), new VarExp("c"),"*"), new ValueExp(new IntValue(10)),new CompStmt(new PrintStmt(new VarExp("a")), new PrintStmt(new VarExp("b"))), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))), new PrintStmt(new ValueExp(new IntValue(200)))), new PrintStmt(new ValueExp(new IntValue(300)))),
