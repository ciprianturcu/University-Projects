    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new StackClass<>(), new DictionaryClass<>(), new ListClass<>(), selectedStatement, new DictionaryClass<>(), new HeapClass(), new BarrierTableClass());
