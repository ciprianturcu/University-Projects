...
public class PrgState {
    ...
    private InterfaceBarrierTable barrierTable;
    private int id;
    private static int lastId =0;
    private IStmt originalProgram;


    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceDictionary<String, Value> symbolTable, InterfaceList<Value> out, IStmt program, InterfaceDictionary<String, BufferedReader> fileTable, InterfaceHeap heap, InterfaceBarrierTable barrierTable) {
    ...
    public InterfaceBarrierTable getBarrierTable() {
        return barrierTable;
    }

    public void setBarrierTable(InterfaceBarrierTable barrierTable) {
        this.barrierTable = barrierTable;
    }
