                     ...
                     new CompStmt(new VarDeclStmt("b", new RefType( new IntType())),
                             new CompStmt( new VarDeclStmt("v", new IntType()),
                                     new CompStmt(new NewStmt("a", new ValueExp(new IntValue(0))),
                                             new CompStmt(new NewStmt("b", new ValueExp(new IntValue(0))),new CompStmt(new HeapWriteStmt("a", new ValueExp(new IntValue(1))),new CompStmt(new HeapWriteStmt("b", new ValueExp(new IntValue(2))),
                                                new CompStmt(new ConditionalAssignmentStmt("v"
                                                        ...
                                                        new CompStmt(new PrintStmt(new VarExp("v")),
                                                                new CompStmt(new ConditionalAssignmentStmt("v",
                                                                                    ...
                                                                                    new ValueExp(new IntValue(100)),
                                                                                    new ValueExp(new IntValue(200))),new PrintStmt(new VarExp("v"))))))))))));
