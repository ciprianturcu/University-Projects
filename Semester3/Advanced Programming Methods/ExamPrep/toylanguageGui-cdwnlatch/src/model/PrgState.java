...
public class PrgState {
    ...
    private InterfaceLatchTable latchTable;
    private int id;
    private static int lastId =0;
    private IStmt originalProgram;


    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceDictionary<String, Value> symbolTable, InterfaceList<Value> out, IStmt program, InterfaceDictionary<String, BufferedReader> fileTable, InterfaceHeap heap, InterfaceLatchTable latchTable) {
    ...
    public InterfaceLatchTable getLatchTable() {
        return latchTable;
    }

    public void setLatchTable(InterfaceLatchTable latchTable) {
        this.latchTable = latchTable;
    }
