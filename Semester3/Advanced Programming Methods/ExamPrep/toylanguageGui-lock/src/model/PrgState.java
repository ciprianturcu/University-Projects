...
public class PrgState {
    ...
    private InterfaceLockTable lockTable;
    private int id;
    private static int lastId =0;
    private IStmt originalProgram;


    public PrgState(InterfaceStack<IStmt> exeStack, InterfaceDictionary<String, Value> symbolTable, InterfaceList<Value> out, IStmt program, InterfaceDictionary<String, BufferedReader> fileTable, InterfaceHeap heap, InterfaceLockTable lockTable) {
    ...
    public InterfaceLockTable getLockTable() {
        return lockTable;
    }

    public void setLockTable(InterfaceLockTable lockTable) {
        this.lockTable = lockTable;
    }
