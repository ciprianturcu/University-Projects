...
import java.util.stream.Stream;
    ...
    public List<PrgState> removeCompletedProgram(List<PrgState> programStateList)
    {
...
//        });
    ...
    public void cleanUp()
    {
        ...
        repository.setProgramList(removeCompletedProgram(repository.getProgramList()));
    ...
    public void oneStepAll() throws InterruptedException {
        executorService = Executors.newFixedThreadPool(2);
        repository.setProgramList(removeCompletedProgram(repository.getProgramList()));
        List<PrgState> programStates = repository.getProgramList();
        if(programStates.size() > 0)
        {
            try{
                oneStepForAllPrograms(repository.getProgramList());
